...
- Quais as ações (casos de uso) que essa aplicação deve ter?
    - Alertas de estoque por e-mail e SMS
    ...
    - Detalhes de produtos vendidos
        - Poder ver quantos produtos vendemos em um determinado período, qual foi o lucro gerado por produto e quais **produtos** estão vendendo melhor em cada período.
    - Atualizações automáticas sobre os prazos de novas remessas
    - Cadastro da quantidade de produtos no estoque
